    ...
    <div class="friend-wrap">
      <div class="friend-main">
        ...
        <div @click="clickLetter()" class="form-wrap">
          <!-- 信封上面 -->
          <img class="before-img" :src="'https://tuchuang.voooe.cn/images/2024/08/14/friendLetterTop.png'" style="width: 100%;"/>
          <!-- 信 -->
          ...
          <img class="after-img" :src="'https://tuchuang.voooe.cn/images/2024/08/14/friendLetterBottom.png'" style="width: 100%;"/>
        </div>
